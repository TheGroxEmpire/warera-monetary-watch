...
class WageEventRaw(Base):
    ...
    worker_country_id: Mapped[str | None] = mapped_column(String(24), nullable=True, index=True)
...
class HourlyTaxRollup(Base):
    ...
    is_foreign_worker: Mapped[bool] = mapped_column(Boolean, primary_key=True, default=False)
